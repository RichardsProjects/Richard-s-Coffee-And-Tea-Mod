...
import net.richardsprojects.teamod.model.cups.ModelFullTeaCup;

@SideOnly(Side.CLIENT)
public class FullTeaCupRenderer extends TileEntitySpecialRenderer {
       
        //The model of your block
        private final ModelFullTeaCup model1 = new ModelFullTeaCup();
       
        public FullTeaCupRenderer() {
