...
public class BlockHalfCoffeeCup extends BlockContainer {
	
	protected BlockHalfCoffeeCup(Material mat)
	{
		super(mat);
	...
	{
		halfCoffeeCup = new BlockHalfCoffeeCup(Material.wood).setBlockName("halfCoffeeCup").setBlockTextureName("iron_block").setHardness(1F).setCreativeTab(null);
	}
    ...
    {
        return ItemCoffeeCup.halfCoffeeCup;
    }
	...
	{
		return new ItemStack(ItemCoffeeCup.halfCoffeeCup, 1);
	}
}
