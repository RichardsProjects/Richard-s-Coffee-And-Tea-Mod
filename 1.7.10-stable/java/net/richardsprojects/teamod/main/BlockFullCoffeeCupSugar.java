...
public class BlockFullCoffeeCupSugar extends BlockContainer {
	
	protected BlockFullCoffeeCupSugar(Material mat)
	{
		super(mat);
	...
	public static Block fullCoffeeCupSugar;
	
	public static void initializeBlock()
	{
		fullCoffeeCupSugar = new BlockFullCoffeeCupSugar(Material.wood).setBlockName("fullCoffeeCupSugar").setBlockTextureName("iron_block").setHardness(1F).setCreativeTab(null);
	}
	
	public static void registerBlock()
	{
		GameRegistry.registerBlock(fullCoffeeCupSugar, fullCoffeeCupSugar.getUnlocalizedName());
	}
    ...
    {
        return ItemCoffeeCupSugar.fullCoffeeCupSugar;
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int idk1, float idk2, float idk3, float idk4)
    {
		...
		else
		{
			if(!world.isRemote)
			{
				...
				world.setBlock(x, y, z, BlockHalfCoffeeCupSugar.halfCoffeeCup, metadata, 3);
	...
	{
		return new ItemStack(ItemCoffeeCupSugar.fullCoffeeCupSugar, 1);
	}
