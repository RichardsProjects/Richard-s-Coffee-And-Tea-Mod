...
import net.richardsprojects.teamod.model.cups.ModelHalfCoffeeCup;
import net.richardsprojects.teamod.model.cups.ModelHalfTeaCup;

@SideOnly(Side.CLIENT)
public class HalfTeaCupRenderer extends TileEntitySpecialRenderer {
       
        //The model of your block
        private final ModelHalfTeaCup model1 = new ModelHalfTeaCup();
       
        public HalfTeaCupRenderer() {
