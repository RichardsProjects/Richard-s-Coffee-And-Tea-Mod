...
public class CoffeeBushRenderer extends TileEntitySpecialRenderer {

	public CoffeeBushRenderer()
	{
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale)
	{
		...
		{
			//Set Texture
			ResourceLocation texture = (new ResourceLocation("teamod:textures/blocks/CoffeeStage1_4.png"));
			Minecraft.getMinecraft().renderEngine.bindTexture(texture);
		...
		{
			//Set Texture
			ResourceLocation texture = (new ResourceLocation("teamod:textures/blocks/CoffeeStage5.png"));
			Minecraft.getMinecraft().renderEngine.bindTexture(texture);
		...
		{
			//Set Texture
			ResourceLocation texture = (new ResourceLocation("teamod:textures/blocks/CoffeeStage6.png"));
			Minecraft.getMinecraft().renderEngine.bindTexture(texture);
		...
		{
			//Set Texture
			ResourceLocation texture = (new ResourceLocation("teamod:textures/blocks/CoffeeStage7.png"));
			Minecraft.getMinecraft().renderEngine.bindTexture(texture);
