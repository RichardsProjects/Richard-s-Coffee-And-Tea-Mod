...
public class ModelFullTeaCup extends ModelBase
{
  //fields
  ...
  public ModelFullTeaCup()
  {
    ...
    textureHeight = 32;
      ...
      Liquid.setRotationPoint(-2F, 17F, -2F);
  ...
  public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5, int metadata)
  {
    ...
    Handle2.render(f5);
    Handle3.render(f5);
    Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("teamod:textures/blocks/tea.png"));
    Liquid.render(f5);
  }
