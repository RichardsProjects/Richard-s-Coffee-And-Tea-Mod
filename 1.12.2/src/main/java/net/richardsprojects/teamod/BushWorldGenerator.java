...
public class BushWorldGenerator implements IWorldGenerator {
	...
	private void generateSurface(World world, Random random, int chunkX, int chunkZ) {
		 ...
		 Biome b = world.getBiomeForCoordsBody(new BlockPos(chunk.x, chunk.z, 60));
         if(b.getBiomeName().endsWith("Plains") || b.getBiomeName().endsWith("Hills") || b.getBiomeName().endsWith("Hills+"))
         {
