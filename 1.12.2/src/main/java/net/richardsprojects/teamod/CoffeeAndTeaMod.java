...
@Mod(modid = References.MODID, name = References.MOD_NAME, version = References.VERSION, dependencies = "after:applecore")
public class CoffeeAndTeaMod {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		CoffeeAndTeaModItemBlocks.init();
	...
	public void postInit(FMLPostInitializationEvent event) {
		Recipes.registerSmelting(); // add smelting recipes
	}
}